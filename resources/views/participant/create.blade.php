				...
				<fieldset>
					<div class="form-group">
						<p class='col-sm-offset-2 col-sm-10'>
							The file with the attendees authorized to attend must be a comma-separated values (CSV)
					...
					<div class="form-group">
						<ol class="list-group col-sm-offset-3 col-sm-6">
							...
							<li class="list-group-item">ID to be used to validate the attendees</li>
							<li class="list-group-item">E-mail of the attendee</li>
						</ol>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-9">
							<button type="submit" class="btn btn-default">
								Add attendees <i class="fa fa-plus"></i>
							</button>
						</div>
					</fieldset>
				</form>
